...
def sendEmail(to, content):
    ...
    server.login('19r21a0599@mlrinstitutions.ac.in', 'Krishna@123')
    server.sendmail('19r21a0599@mlrinstitutions.ac.in', to, content)
    server.close()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif "activate scroll" in query or "scroll" in query:
            try:
                print("mouse controls activated")
        ...
        elif "activate system controls" in query:
            try:
            ...
            speak("I am your virtual assistant created by Ramakrishna")
